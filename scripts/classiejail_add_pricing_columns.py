#!/usr/bin/env python3
"""
Add pricing columns to ClassieJail_DineIn_vs_Zomato.xlsx

Zomato commission 37% -> R_z = Z * 0.63
Our commission 25% -> restaurant P * 0.75, platform P * 0.25

P = (0.40 * Z + 0.60 * R_z) / 0.85, rounded to nearest ₹1

No Zomato price (blank / - / None): P = round(D * 1.35), Our Hike on Dine-in % = 35 (fixed).

Expected columns A–E:
  Category | Sub-Category | Item Name | Dine-In Price (₹) | Zomato Price (₹)
"""
...
XLSX = "/Users/user/Downloads/ClassieJail_DineIn_vs_Zomato.xlsx"
